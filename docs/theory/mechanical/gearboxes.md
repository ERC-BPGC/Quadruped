...
<div className="figure-grid figure-grid--two figure-grid--compact">
  <figure>
    <img src={require('../../mechanical/assets/gearboxes/planetary-gearbox.webp').default} alt="Planetary gearbox labeled with sun gear, planet gears, ring gear, and carrier" />
    <figcaption>Planetary gearbox layout: sun gear, planet gears, ring gear, and carrier.</figcaption>
  </figure>
  <figure>
    <img src={require('../../mechanical/assets/gearboxes/planetary_drive.gif').default} alt="Animated planetary gear motion" />
...
<div className="figure-grid figure-grid--two figure-grid--compact">
  <figure>
    <img src={require('../../mechanical/assets/gearboxes/cycloidal-gearbox.jpg').default} alt="Exploded cycloidal drive with input shaft, eccentric bearing, cycloidal disk, ring gear, and output shaft" />
    <figcaption>Cycloidal drive components: eccentric input, cycloidal disc, ring pins/rollers, and output pins.</figcaption>
  </figure>
  <figure>
    <img src={require('../../mechanical/assets/gearboxes/cycloidal_drive.gif').default} alt="Animated cycloidal drive motion" />
...
<div className="figure-grid figure-grid--two figure-grid--compact">
  <figure>
    <img src={require('../../mechanical/assets/gearboxes/harmonic-gearbox.jpg').default} alt="Harmonic drive showing circular spline, flex spline, and wave generator" />
    <figcaption>Harmonic drive components: circular spline, flex spline, and wave generator.</figcaption>
  </figure>
  <figure>
    <img src={require('../../mechanical/assets/gearboxes/harmonic_drive.gif').default} alt="Animated harmonic drive motion" />
...
<div className="figure-grid figure-grid--two figure-grid--compact">
  <figure>
    <img src={require('../../mechanical/assets/gearboxes/worm-gearbox.webp').default} alt="Cutaway worm gearbox showing worm and worm wheel" />
    <figcaption>Worm gearbox layout with worm and worm wheel.</figcaption>
  </figure>
  <figure>
    <img src={require('../../mechanical/assets/gearboxes/worm_drive.gif').default} alt="Animated worm gear motion" />

...
<div className="figure-grid figure-grid--four">
  <figure>
    <img src={require('./assets/motors/DC.jpeg').default} alt="Small brushed DC motor" />
    <figcaption>Brushed DC motor</figcaption>
  </figure>
  <figure>
    <img src={require('./assets/motors/servo.jpeg').default} alt="Small hobby servo motor" />
    <figcaption>Servo motor</figcaption>
  </figure>
  <figure>
    <img src={require('./assets/motors/stepper.jpeg').default} alt="Stepper motor" />
    <figcaption>Stepper motor</figcaption>
  </figure>
  <figure>
    <img src={require('./assets/motors/BLDC.png').default} alt="BLDC outrunner motor" />
...
<figure className="figure--small">
  <img src={require('./assets/motors/pancake_BLDC.jpg').default} alt="Low-KV pancake BLDC motor" />

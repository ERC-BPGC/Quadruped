...
class Q1Env:
    def __init__(self, num_envs, env_cfg, obs_cfg, reward_cfg, command_cfg, show_viewer=False):
        ...
        # But we apply +90° X rotation to sensor readings for correct IMU frame
        ...
        # Note: MJCF models may have their own base orientation in the XML file
        # The quat here is applied on top of the XML's base orientation
        ...
        print(f"[Q1Env] DOF indices: {self.motors_dof_idx}")
    ...
    #     # Penalize angular velocity in x and y (roll and pitch rates)
    #     return torch.sum(torch.square(self.base_ang_vel[:, :2]), dim=1)

    # def _reward_orientation(self):
    #     # Penalize non-flat base orientation (from projected gravity)
    ...
    #     # Penalize collisions (if robot has collision detection)
    #     # This is a placeholder - would need collision detection to be properly implemented
